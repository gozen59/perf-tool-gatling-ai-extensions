...
When the **gatling** MCP server is configured in Cursor, use its tools to fetch teams, locations, packages, and simulations from the user's Gatling Enterprise account before authoring or updating `package.conf`.
